...
.agr-section h2 { font-size: clamp(1.4rem, 3.2vw, 1.9rem); font-weight: 800; letter-spacing: -0.02em; margin-bottom: 14px; }
...
.agr-step h3 { font-size: 1.05rem; font-weight: 600; margin: 10px 0 8px; }
.agr-step p { font-size: 0.9rem; color: var(--slate); }
...
.agr-module h3 { font-size: 1.05rem; font-weight: 600; margin-bottom: 8px; }
.agr-module p { font-size: 0.88rem; color: var(--slate); flex: 1; margin-bottom: 16px; }
.agr-module a, .agr-module span.agr-module-here { font-size: 0.85rem; font-weight: 600; color: var(--indigo); text-decoration: none; }
...
.agr-security-box p { color: var(--slate); font-size: 0.92rem; }
